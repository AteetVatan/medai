...
class StorageService:
    ...
    async def create_patient(
        self, organization_id: str, patient_data: Dict[str, Any], user_id: str
    ) -> Dict[str, Any]:
    ...
    async def create_encounter(
        self, organization_id: str, encounter_data: Dict[str, Any], user_id: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            result = (
                self.supabase.table("encounters").insert(encounter_record).execute()
            )
    ...
    async def save_audio_record(
        ...
        try:
            ...
            upload_result = self.supabase.storage.from_("audio").upload(
                file_path, audio_data, file_options={"content-type": "audio/wav"}
            )
            ...
            audio_record = {
                ...
                "transcription_confidence": audio_metadata.get(
                    "transcription_confidence"
                ),
                "processing_status": audio_metadata.get(
    ...
    async def save_medical_entities(
        ...
        try:
            ...
            result = (
                self.supabase.table("medical_entities").insert(entity_records).execute()
            )
    ...
    async def save_clinical_notes(
        ...
        try:
            ...
            result = (
                self.supabase.table("clinical_notes").insert(notes_record).execute()
            )
    ...
    async def get_signed_url(
        self, file_path: str, expires_in: int = 3600, user_id: str = "system"
    ) -> str:
    ...
    async def search_patients(
        self, organization_id: str, query: str, user_id: str, limit: int = 20
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            result = (
                ...
                .text_search("first_name,last_name,patient_number", query)
                .limit(limit)
                .execute()
            )
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "service": "storage",
                "status": "healthy",
                "database": {"status": "healthy", "latency_ms": db_latency},
                "storage": {"status": "healthy", "latency_ms": storage_latency},
                "timestamp": time.time(),
            }

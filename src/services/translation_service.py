...
class TranslationService:
    ...
    async def translate_text(
        ...
        try:
            ...
            if threshold_exceeded:
                logger.warning(f"Translation latency {latency_ms:.1f}ms exceeds threshold {settings.translation_threshold}ms")
    ...
    async def translate_clinical_notes(
        ...
        try:
            ...
            text_fields = [
                "hauptbeschwerden", "aktuelle_symptome", "medizinische_vorgeschichte",
                "medikamente", "allergien", "befunde", "diagnose_verdacht",
                "behandlungsplan", "naechste_schritte"
            ]
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "successful_translations": self.performance_stats["successful_translations"],

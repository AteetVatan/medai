...
class EncounterCreate(BaseModel):
    ...
    notes: Optional[Dict[str, Any]] = Field(default_factory=dict, description="Initial notes")
...
class ClinicalIntakeRequest(BaseModel):
    ...
    task_type: str = Field(default="intake_summary", description="Type of clinical task")

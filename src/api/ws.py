...
async def websocket_endpoint(websocket: WebSocket, session_id: str = None, user_id: str = "demo_user", organization_id: str = "demo_org"):
    ...
    try:
        while True:
            ...
            ws_manager.update_session_data(session_id, {"last_activity": asyncio.get_event_loop().time()})
...
async def handle_start_session(session_id: str, data: Dict[str, Any]):
    ...
    # Update session data
    ws_manager.update_session_data(session_id, {
...
async def websocket_fastapi_endpoint(websocket: WebSocket, session_id: str = None, user_id: str = "demo_user", organization_id: str = "demo_org"):
    """FastAPI WebSocket endpoint."""

...
from src.services.ner_service import MedicalNERService, ner_service, MedicalEntity, ICDDictionary
    ...
    def test_fuzzy_match_variations(self):
        ...
        for variation, expected_key in test_cases:
            ...
            if result:
                ...
                assert result["category"] in ["symptom", "diagnosis", "medication", "anatomy"]
...
class TestMedicalNERService:
    ...
    @pytest.mark.asyncio
    async def test_extract_entities_success(self, ner_service_instance, sample_medical_text):
    ...
    async def test_extract_entities_with_icd_mapping(self, ner_service_instance):
        ...
        with patch.object(ner_service_instance, 'nlp') as mock_nlp:
            ...
            kopfschmerzen_entity = next((e for e in entities if e.text == "Kopfschmerzen"), None)
    ...
    def test_get_entity_statistics(self, ner_service_instance):
        ...
        entities = [
            MedicalEntity("Kopfschmerzen", "SYMPTOM", 0, 12, 0.9, "R51", "Kopfschmerz", "symptom"),
            MedicalEntity("Diabetes", "DIAGNOSIS", 15, 22, 0.8, "E11", "Diabetes mellitus", "diagnosis"),
            MedicalEntity("Aspirin", "MEDICATION", 25, 32, 0.95, "N02BA01", "Acetylsalicylsäure", "medication")
        ]
    ...
    async def test_health_check(self, ner_service_instance):
        ...
        with patch.object(ner_service_instance, 'extract_entities') as mock_extract:
            mock_extract.return_value = [
                MedicalEntity("Test", "SYMPTOM", 0, 4, 0.9)
            ]

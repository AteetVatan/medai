...
class TestTranslationService:
    ...
    @pytest.mark.asyncio
    async def test_translate_text_google_success(
        self, translation_service_instance, sample_text
    ):
        ...
        with patch(
            ...
            mock_gt = MagicMock()
            mock_gt.translate.return_value = (
            ...
            result = await translation_service_instance.translate_text(
                text=sample_text, source_lang="de", target_lang="en"
            )
    ...
    @pytest.mark.asyncio
    async def test_translate_text_google_failure(
        self, translation_service_instance, sample_text
    ):
    ...
    async def test_translate_text_empty_text(self, translation_service_instance):
        ...
        result = await translation_service_instance.translate_text(
            text="", source_lang="de", target_lang="en"
        )
    ...
    async def test_translate_batch(self, translation_service_instance):
        ...
        with patch(
            ...
            results = await translation_service_instance.translate_batch(
                texts=texts, source_lang="de", target_lang="en"
            )
    ...
    @pytest.mark.asyncio
    async def test_translate_clinical_notes_success(
        self, translation_service_instance, sample_clinical_notes
    ):
        ...
        with patch(
            ...
            result = await translation_service_instance.translate_clinical_notes(
                clinical_notes=sample_clinical_notes, target_lang="en"
            )
    ...
    @pytest.mark.asyncio
    async def test_translate_clinical_notes_failure(
        self, translation_service_instance, sample_clinical_notes
    ):
